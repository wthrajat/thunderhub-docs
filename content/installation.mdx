...
<Callout type="info">
  **Using an AI coding agent?** Drop our ready-made [`AGENTS.md`](/agents-md)
  into your ThunderHub repo root and your agent can handle the full setup for
  you — including litd and Taproot Assets.
</Callout>
