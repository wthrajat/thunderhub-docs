...
<Callout type="info">
  **Want a public URL in minutes?** Skip the local install and follow our
  [Deploy to Fly.io](/installation/fly-io) guide. ThunderHub runs in the cloud
  and connects to any Lightning node you can reach.
</Callout>

<Callout type="info">
  **Using an AI coding agent?** Drop our ready-made
  [`AGENTS.md`](/installation/agents-md) into your ThunderHub repo root and your
  agent can handle the full setup for you — including litd and Taproot Assets.
</Callout>
